...
if __name__ == '__main__':
    ...
    if 0:
        net = cv2.dnn.readNetFromTensorflow("yolov3-coco/yolov3_tiny_model.pb", "yolov3-coco/yolov3_tiny_model.pbtxt")
    if 0:
        net = cv2.dnn.readNetFromModelOptimizer("yolov3-coco/yolov3_tiny_model.xml", "yolov3-coco/yolov3_tiny_model.bin")
